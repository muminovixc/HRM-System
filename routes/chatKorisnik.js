...
router.get('/', async (req, res) => {
    res.render('Korisnik/chatKorisnik')
})
...
// Ruta za dobijanje liste korisnika
...
router.post('/send-message', async (req, res) => {
    ...
    try {
        const result = await pool.query('INSERT INTO poruke(posaljitelj_id,primatelj_id, poruka) VALUES($1, $2, $3)', [fromUserId, toUserId, message]);
